...
import com.vincent.mall.mallware.entity.WmsPurchaseDetailEntity;
import com.vincent.mall.mallware.service.WmsPurchaseDetailService;
 ...
 */
@RestController
@RequestMapping("mallware/wmspurchasedetail")
public class WmsPurchaseDetailController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("mallware:wmspurchasedetail:list")
    ...
    //@RequiresPermissions("mallware:wmspurchasedetail:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("mallware:wmspurchasedetail:save")
    ...
    //@RequiresPermissions("mallware:wmspurchasedetail:update")
    ...
    //@RequiresPermissions("mallware:wmspurchasedetail:delete")
