...
import com.vincent.mall.mallware.service.WmsWareOrderTaskDetailService;
 ...
 */
@RestController
@RequestMapping("mallware/wmswareordertaskdetail")
public class WmsWareOrderTaskDetailController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("mallware:wmswareordertaskdetail:list")
    ...
    //@RequiresPermissions("mallware:wmswareordertaskdetail:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("mallware:wmswareordertaskdetail:save")
    ...
    //@RequiresPermissions("mallware:wmswareordertaskdetail:update")
    ...
    //@RequiresPermissions("mallware:wmswareordertaskdetail:delete")
